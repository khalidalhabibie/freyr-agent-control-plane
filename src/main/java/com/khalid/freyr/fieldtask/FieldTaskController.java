...
public class FieldTaskController {
    ...
    public ApiResponse<List<FieldTaskResponse>> getUnassignedTasksByDistrictAndDueDate(
            @RequestParam String district,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate dueDate
    ) {
        List<FieldTaskResponse> fieldTasks = fieldTaskService.getUnassignedTasksByDistrictAndDueDate(district, dueDate);

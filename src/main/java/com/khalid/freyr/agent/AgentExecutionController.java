...
public class AgentExecutionController {
    ...
    public ApiResponse<List<AgentExecutionResponse>> getAgentExecutions() {
        List<AgentExecutionResponse> executions = agentExecutionService.getAgentExecutions();
    ...
    public ApiResponse<AgentExecutionResponse> getAgentExecution(@PathVariable UUID id) {
        AgentExecutionResponse execution = agentExecutionService.getAgentExecution(id);
